  ...
  document.querySelector('.show').style.visibility = "visible";
   ...
   function calculate(){
    ...
    var minutes = Math.floor((seconds/60) %60);
     ...
     if (minutes == 1)
     {
       document.querySelector('.hmins').innerHTML = "Min";
     }
     if (minutes != 1)
     {
       document.querySelector('.hmins').innerHTML = "Mins";
     }
     if (seconds == 1)
     {
       document.querySelector('.hsecs').innerHTML = "Sec";
     }
     if (seconds != 1)
     {
       document.querySelector('.hsecs').innerHTML = "Secs";
     }
     if (hours < 10)
     {
       hours = '0' + hours;
